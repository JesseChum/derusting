...
public int birthYear(int currentYear){
  ...
  Person person = new Person("Qin Bao", 32);
    // Create another instance of Person with a different name and age and
    // assign it to a different variable
  Person person2 = new Person("Yellow Yao", 24);
...
System.out.println(person2);
  ...
  String firstPersonName = person.name;
    ...
    // as the argument.
  int firstPersonBirthYear = person.birthYear(2025);
    // In a separate statement, print the local variable holding the birth year.
  System.out.println("First Person's Name: " + firstPersonName);
  System.out.println("First Person's birthyear: " + firstPersonBirthYear);
    /**
     * Terminology!
     * 
